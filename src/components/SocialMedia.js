            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-3 margin-t-30">
                        <p className="margin-b-0 contact-title"><i className="pe-7s-call"></i> &nbsp;+52 55 1125 3250</p>
                    </div>
                    <div className="col-lg-3 margin-t-30 text-right">
                        <p className="contact-title"><i className="pe-7s-mail-open"></i>&nbsp; contacto@tapcarads.com</p>
                    </div>
                </div>
            </div>
        </section>
