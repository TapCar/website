                ...
                <div className="row margin-t-30">
                    <div className="col-lg-4 margin-t-20">
                        <div className="services-box text-center hover-effect">
                            ...
                            <h4 className="padding-t-15">Campañas de Awareness</h4>
                    ...
                    <div className="col-lg-4 margin-t-20">
                        <div className="services-box text-center hover-effect">
                            ...
                            <h4 className="padding-t-15">Campañas de Leads</h4>
                    ...
                    <div className="col-lg-4 margin-t-20">
                        <div className="services-box text-center hover-effect">
                            ...
                            <h4 className="padding-t-15">Campañas geosegmentadas</h4>
                ...
                <div className="row margin-t-30">
                    <div className="col-lg-4 margin-t-20">
                        <div className="services-box text-center hover-effect">
                            ...
                            <h4 className="padding-t-15">Programmatic Marketing</h4>
                    ...
                    <div className="col-lg-4 margin-t-20">
                        <div className="services-box text-center hover-effect">
                            ...
                            <h4 className="padding-t-15">Presupuestos flexibles</h4>
                    ...
                    <div className="col-lg-4 margin-t-20">
                        <div className="services-box text-center hover-effect">
                            ...
                            <h4 className="padding-t-15">Reportes en tiempo real</h4>
